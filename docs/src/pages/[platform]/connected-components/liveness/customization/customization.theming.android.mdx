import { TokenItem, TokenPath, TokenMeta } from '@/components/Theming/TokenItem';
import { ColorSwatch } from '@/components/Theming/ColorSwatch';
...
<ul className="docs-tokenGroup docs-tokenGroup--list">
    <TokenItem namespace={"colors"} key={"android"}>
        <ColorSwatch color={"var(--amplify-colors-teal-80)"} />
        <TokenPath path={["android", "primary"]} />
        <TokenMeta>{"Color(0xFF047D95)"}</TokenMeta>
    </TokenItem>
    <TokenItem namespace={"colors"} key={"android"}>
        <ColorSwatch color={"var(--amplify-colors-white)"} />
    ...
    <TokenItem namespace={"colors"} key={"android"}>
        <ColorSwatch color={"var(--amplify-colors-neutral-100)"} />
    ...
    <TokenItem namespace={"colors"} key={"android"}>
        <ColorSwatch color={"var(--amplify-colors-red-80)"} />
    ...
    <TokenItem namespace={"colors"} key={"android"}>
        <ColorSwatch color={"var(--amplify-colors-orange-20)"} />
        <TokenPath path={["android", "errorContainer"]} />
        <TokenMeta>{"Color(0xFFF5D9BC)"}</TokenMeta>
    </TokenItem>
    <TokenItem namespace={"colors"} key={"android"}>
        <ColorSwatch color={"var(--amplify-colors-orange-80)"} />
...
<ul className="docs-tokenGroup docs-tokenGroup--list">
    <TokenItem namespace={"colors"} key={"android"}>
        <ColorSwatch color={"var(--amplify-colors-teal-40)"} />
        <TokenPath path={["android", "primary"]} />
    ...
    <TokenItem namespace={"colors"} key={"android"}>
        <ColorSwatch color={"var(--amplify-colors-red-40)"} />
        <TokenPath path={["android", "error"]} />
